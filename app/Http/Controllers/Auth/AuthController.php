...
//            return response()->json([
//                'message' => 'Este email ya está en uso. Por favor, vuelva a intentarlo con otro correo',
...
//        }
        ...
        {
            return response()->json([
                'message' => 'Ha ocurrido un error al crear la cuenta. Compruebe que el correo es válido y vuelva a intentarlo',
                'title' => 'Datos incorrectos'
            ], 422);
        }
